...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <div class="auth-subtitle">
            Tạo tài khoản để đặt lịch và trải nghiệm dịch vụ HomeBeauty
        </div>
        ...
        <form action="{{ route('customer.register.submit') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="full_name" class="form-control"
                       placeholder="Nhập họ tên" value="{{ old('full_name') }}" required>
            ...
            <button class="btn btn-auth w-100">Đăng ký</button>
        </form>
